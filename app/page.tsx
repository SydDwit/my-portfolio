                ...
                <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-xl hover:shadow-2xl transition-all duration-500">
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {[
                        { name: "React", logo: <svg className="w-6 h-6" viewBox="0 0 24 24" fill="#61DAFB"><circle cx="12" cy="12" r="2"/><path d="M12 7c-2.76 0-5.326 1.222-7.071 3.357C3.185 12.493 2 15.02 2 18c0 2.98 1.185 5.507 2.929 7.643C6.674 27.778 9.24 29 12 29s5.326-1.222 7.071-3.357C20.815 23.507 22 20.98 22 18c0-2.98-1.185-5.507-2.929-7.643C17.326 8.222 14.76 7 12 7z" opacity="0.3"/><ellipse cx="12" cy="12" rx="9" ry="3" fill="none" stroke="#61DAFB" strokeWidth="1"/><ellipse cx="12" cy="12" rx="9" ry="3" fill="none" stroke="#61DAFB" strokeWidth="1" transform="rotate(60 12 12)"/><ellipse cx="12" cy="12" rx="9" ry="3" fill="none" stroke="#61DAFB" strokeWidth="1" transform="rotate(120 12 12)"/></svg> },
                        { name: "Next.js", logo: <svg className="w-6 h-6" viewBox="0 0 24 24" fill="#000000"><path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm4.5 16.5L9 10v8.5c0 .276-.224.5-.5.5s-.5-.224-.5-.5v-9c0-.276.224-.5.5-.5.138 0 .263.056.354.146l8.146 8.146c-.682.452-1.417.828-2.193 1.117zM12 20c-4.411 0-8-3.589-8-8s3.589-8 8-8 8 3.589 8 8-3.589 8-8 8z"/></svg> },
                        { name: "TypeScript", logo: <svg className="w-6 h-6" viewBox="0 0 24 24"><rect width="24" height="24" fill="#3178C6" rx="2"/><path d="M9.5 9V8h5v1h-2v8h-1V9h-2zm6.5 0v1h2v1h-2v2h2v1h-2v2h2v1h-3V8h3v1h-2z" fill="white"/></svg> },
                        { name: "JavaScript", logo: <svg className="w-6 h-6" viewBox="0 0 24 24"><rect width="24" height="24" fill="#F7DF1E"/><path d="M7.5 17.5c0 1.5 1 2.5 2.5 2.5s2.5-1 2.5-2.5V11h-2v6.5c0 .5-.5 1-1 1s-1-.5-1-1V11h-2v6.5zM16 20c1.5 0 2.5-1 2.5-2.5S17.5 15 16 15s-2.5 1-2.5 2.5S14.5 20 16 20zm0-4c.5 0 1 .5 1 1s-.5 1-1 1-1-.5-1-1 .5-1 1-1z" fill="black"/></svg> },
                        { name: "HTML5", logo: <svg className="w-6 h-6" viewBox="0 0 24 24" fill="#E34F26"><path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.564-2.438L1.5 0zm7.031 9.75l-.232-2.718 10.059.003.23-2.622L5.412 4.41l.698 8.01h9.126l-.326 3.426-2.91.804-2.955-.81-.188-2.11H6.248l.33 4.171L12 19.351l5.379-1.443.744-8.157H8.531z"/></svg> },
                        { name: "CSS3", logo: <svg className="w-6 h-6" viewBox="0 0 24 24" fill="#1572B6"><path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.564-2.438L1.5 0zm17.09 4.413L5.41 4.41l.213 2.622 10.125.002-.255 2.716h-6.64l.24 2.573h6.182l-.366 3.523-2.91.804-2.956-.81-.188-2.11h-2.61l.29 3.855L12 19.288l5.373-1.53L18.59 4.414z"/></svg> },
                        ...
                        { name: "Bootstrap", logo: <svg className="w-6 h-6" viewBox="0 0 24 24" fill="#7952B3"><path d="M11.77 11.24H9.956V8.202h2.152c1.17 0 1.834.522 1.834 1.466 0 1.008-.773 1.572-2.174 1.572zm.324 1.206H9.957v3.348h2.231c1.459 0 2.232-.585 2.232-1.685s-.795-1.663-2.326-1.663zM24 12v12H0V0h24v12zM8.5 5.5a1 1 0 0 0-1 1v11a1 1 0 0 0 1 1h3.5c2.5 0 4-1.5 4-4 0-1.5-.5-2.5-1.5-3 1-.5 1.5-1.5 1.5-3 0-2.5-1.5-4-4-4H8.5z"/></svg> }
                      ].map((tech) => (
              ...
              <FadeIn delay={0.3}>
                <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-xl hover:shadow-2xl transition-all duration-500">
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {[
                        { name: "Node.js", logo: <svg className="w-6 h-6" viewBox="0 0 24 24" fill="#339933"><path d="M11.998 24c-.321 0-.641-.084-.922-.247l-2.936-1.737c-.438-.245-.224-.331-.08-.382.585-.203.703-.25 1.328-.604.065-.037.151-.023.218.017l2.256 1.339c.082.045.197.045.272 0l8.795-5.076c.082-.047.134-.141.134-.238V6.921c0-.099-.053-.19-.137-.238L11.13.615c-.081-.047-.189-.047-.271 0L2.065 6.68c-.084.05-.138.142-.138.24v10.15c0 .097.054.189.137.237l2.408 1.392c1.307.654 2.108-.116 2.108-0.89V7.787c0-.142.114-.253.256-.253h1.115c.139 0 .255.112.255.253v10.021c0 1.745-.95 2.745-2.604 2.745-.508 0-.909 0-2.026-.551L1.226 18.665c-.57-.329-.922-.943-.922-1.604V6.921c0-.661.353-1.275.922-1.603L9.021.242C9.586-.086 10.413-.086 10.979.242l8.795 5.076c.57.328.922.942.922 1.603v10.14c0 .661-.353 1.276-.922 1.604l-8.795 5.076c-.282.163-.602.247-.922.247zm2.725-7.009c-3.852 0-4.652-1.766-4.652-3.248 0-.141.114-.253.256-.253h1.138c.127 0 .233.093.252.218.171 1.154.682 1.739 3.006 1.739 1.849 0 2.635-.419 2.635-1.399 0-.565-.223-.983-3.096-1.267-2.402-.237-3.886-.767-3.886-2.684 0-1.771 1.492-2.827 3.993-2.827 2.81 0 4.2.976 4.376 3.071.008.069-.018.137-.058.188-.04.051-.096.08-.155.08h-1.138c-.118 0-.219-.085-.248-.2-.275-1.227-.946-1.616-2.777-1.616-2.043 0-2.281.712-2.281 1.245 0 .64.28.827 3.006 1.188 2.698.357 3.976.861 3.976 2.75-.001 1.908-1.591 3.013-4.368 3.013z"/></svg> },
                        { name: "Python", logo: <svg className="w-6 h-6" viewBox="0 0 24 24" fill="#3776ab"><path d="M14.25.18l.9.2.73.26.59.3.45.32.34.34.25.34.16.33.1.3.04.26.02.2-.01.13V8.5l-.05.63-.13.55-.21.46-.26.38-.3.31-.33.25-.35.19-.35.14-.33.1-.3.07-.26.04-.21.02H8.77l-.69.05-.59.14-.5.22-.41.27-.33.32-.27.35-.2.36-.15.37-.1.35-.07.32-.04.27-.02.21v3.06H3.17l-.21-.03-.28-.07-.32-.12-.35-.18-.36-.26-.36-.36-.35-.46-.32-.59-.28-.73-.21-.88-.14-1.05-.05-1.23.06-1.22.16-1.04.24-.87.32-.71.36-.57.4-.44.42-.33.42-.24.4-.16.36-.1.32-.05.24-.01h.16l.06.01h8.16v-.83H6.18l-.01-2.75-.02-.37.05-.34.11-.31.17-.28.25-.26.31-.23.38-.2.44-.18.51-.15.58-.12.64-.1.71-.06.77-.04.84-.02 1.27.05zm-6.3 1.98l-.23.33-.08.41.08.41.23.34.33.22.41.09.41-.09.33-.22.23-.34.08-.41-.08-.41-.23-.33-.33-.22-.41-.09-.41.09zm13.09 3.95l.28.06.32.12.35.18.36.27.36.35.35.47.32.59.28.73.21.88.14 1.04.05 1.23-.06 1.23-.16 1.04-.24.86-.32.71-.36.57-.4.45-.42.33-.42.24-.4.16-.36.09-.32.05-.24.02-.16-.01h-8.22v.82h5.84l.01 2.76.02.36-.05.34-.11.31-.17.29-.25.25-.31.24-.38.2-.44.17-.51.15-.58.13-.64.09-.71.07-.77.04-.84.01-1.27-.04-1.07-.14-.9-.2-.73-.25-.59-.3-.45-.33-.34-.34-.25-.34-.16-.33-.1-.3-.04-.25-.02-.2.01-.13v-5.34l.05-.64.13-.54.21-.46.26-.38.3-.32.33-.24.35-.2.35-.14.33-.1.3-.06.26-.04.21-.02.13-.01h5.84l.69-.05.59-.14.5-.21.41-.28.33-.32.27-.35.2-.36.15-.36.1-.35.07-.32.04-.28.02-.21V6.07h2.09l.14.01zm-6.47 14.25l-.23.33-.08.41.08.4.23.34.33.22.41.09.41-.09.33-.22.23-.34.08-.4-.08-.41-.23-.33-.33-.22-.41-.09-.41.09z"/></svg> },
                        { name: "PHP", logo: <svg className="w-6 h-6" viewBox="0 0 24 24" fill="#777BB4"><ellipse cx="12" cy="12" rx="10" ry="6" fill="#777BB4"/><ellipse cx="12" cy="12" rx="8" ry="4.8" fill="#FFF"/><path d="M5.5 10.5h1.5c.8 0 1.5.7 1.5 1.5s-.7 1.5-1.5 1.5H6v1h-.5v-4zm1 1.5H6v1h.5c.3 0 .5-.2.5-.5s-.2-.5-.5-.5zm5-1.5h1.5c.8 0 1.5.7 1.5 1.5s-.7 1.5-1.5 1.5H12v1h-.5v-4zm1 1.5H12v1h.5c.3 0 .5-.2.5-.5s-.2-.5-.5-.5zm5-1.5h1.5c.8 0 1.5.7 1.5 1.5s-.7 1.5-1.5 1.5H18v1h-.5v-4zm1 1.5H18v1h.5c.3 0 .5-.2.5-.5s-.2-.5-.5-.5z" fill="#777BB4"/></svg> },
                        { name: "Flask", logo: <svg className="w-6 h-6" viewBox="0 0 24 24" fill="#000000"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/><path d="M9 7v2l3 6 3-6V7H9zm2 2h2v1l-1 2-1-2V9z" fill="#000000"/></svg> },
              ...
              <FadeIn delay={0.4}>
                <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-xl hover:shadow-2xl transition-all duration-500">
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {[
                        { name: "PostgreSQL", logo: <svg className="w-6 h-6" viewBox="0 0 24 24" fill="#336791"><path d="M23.5 9.5c-.2-.9-.8-1.7-1.6-2.2-.4-.3-.9-.5-1.4-.6-.3-.1-.7-.1-1-.1v-.1c0-1.4-1.1-2.5-2.5-2.5H15c-.6 0-1.2.2-1.7.6-.5-.4-1.1-.6-1.7-.6H9.5c-1.4 0-2.5 1.1-2.5 2.5v.1c-.3 0-.7 0-1 .1-.5.1-1 .3-1.4.6-.8.5-1.4 1.3-1.6 2.2-.1.5-.1 1 0 1.5.1.9.5 1.7 1.2 2.3.3.3.7.5 1.1.7.2.1.4.2.6.2v4.3c0 1.4 1.1 2.5 2.5 2.5h8c1.4 0 2.5-1.1 2.5-2.5v-4.3c.2 0 .4-.1.6-.2.4-.2.8-.4 1.1-.7.7-.6 1.1-1.4 1.2-2.3.1-.5.1-1 0-1.5z"/></svg> },
                        { name: "MySQL", logo: <svg className="w-6 h-6" viewBox="0 0 24 24" fill="#4479A1"><path d="M16.405 5.501c-.115 0-.193.014-.274.033v.013h.014c.054.104.146.18.214.273.054.107.1.214.154.32l.014-.015c.094-.066.14-.172.14-.333-.04-.047-.046-.094-.08-.14-.04-.067-.126-.1-.18-.15zM5.77 18.695h-.927a50.854 50.854 0 00-.27-4.41h-.008l-1.41 4.41H2.45l-1.4-4.41h-.01a72.892 72.892 0 00-.195 4.41H.022c.055-1.966.192-3.81.41-5.53h1.15l1.335 4.064h.008l1.347-4.064h1.095c.242 1.966.378 3.85.403 5.53zM10.924 18.695h-.955l-2.78-5.53h1.024l2.126 4.533.018-.004 2.1-4.529h.98l-2.513 5.53zM16.405 18.695c-.022-.375-.04-.777-.04-1.224v-2.72c0-.62.062-1.19-.57-1.19-.648 0-.54.528-.54 1.19v.327h-.934v-.196c0-1.306.295-2.52 1.574-2.52 1.163 0 1.54.786 1.54 1.92v4.413h-.03zm-3.17-5.754c.4 0 .784.058 1.114.156.055.016.111.04.111.096 0 .14 0 .28-.018.42-.009.058-.024.058-.062.058-.062-.018-.125-.027-.188-.036a4.986 4.986 0 00-.8-.058c-.446 0-.642.027-.642.383 0 .18.062.29.25.29.49 0 .793-.142 1.303-.346v.422c-.062.058-.125.089-.188.125a3.264 3.264 0 01-.849.228c-.848.036-1.337-.196-1.337-.85 0-.704.453-.888 1.418-.888z"/></svg> },
                        { name: "MongoDB", logo: <svg className="w-6 h-6" viewBox="0 0 24 24" fill="#47A248"><path d="M17.193 9.555c-1.264-5.58-4.252-7.414-4.573-8.115-.28-.394-.53-.954-.735-1.44-.036.495-.055.685-.523 1.184-.723.566-4.438 3.682-4.74 10.02-.282 5.912 4.27 9.435 4.888 9.884l.07.05A73.49 73.49 0 0111.91 24h.481c.114-1.032.284-2.056.51-3.07.417-.296.604-.463.85-.693a11.342 11.342 0 003.639-8.464c.01-.814-.103-1.662-.197-2.218zm-5.336 8.195s0-8.291.275-8.29c.213 0 .49 10.695.49 10.695-.381-.045-.765-1.76-.765-2.405z"/></svg> },
                        { name: "Redis", logo: <svg className="w-6 h-6" viewBox="0 0 24 24" fill="#DC382D"><path d="M10.5 2.661l.54.997-1.797.644-.54-.997L10.5 2.661zm2.077.702l.54.997-1.797.644-.54-.997 1.797-.644zm2.077.702l.54.997-1.797.644-.54-.997 1.797-.644zm2.077.702l.54.997-1.797.644-.54-.997 1.797-.644zM12 5.5c3.589 0 6.5 1.567 6.5 3.5s-2.911 3.5-6.5 3.5S5.5 10.933 5.5 9s2.911-3.5 6.5-3.5zm6.5 8.5c0 1.933-2.911 3.5-6.5 3.5S5.5 15.933 5.5 14v-2.5c1.5 1.8 3.8 2.5 6.5 2.5s5-0.7 6.5-2.5V14zm0 4c0 1.933-2.911 3.5-6.5 3.5S5.5 19.933 5.5 18v-2.5c1.5 1.8 3.8 2.5 6.5 2.5s5-0.7 6.5-2.5V18z"/></svg> },
                        { name: "Git", logo: <svg className="w-6 h-6" viewBox="0 0 24 24" fill="#F05032"><path d="M23.546 10.93L13.067.452c-.604-.603-1.582-.603-2.188 0L8.708 2.627l2.76 2.76c.645-.215 1.379-.07 1.889.441.516.515.658 1.258.438 1.9l2.658 2.66c.645-.223 1.387-.078 1.9.435.721.72.721 1.884 0 2.604-.719.719-1.881.719-2.6 0-.539-.541-.674-1.337-.404-1.996L12.86 8.955v6.525c.176.086.342.203.488.348.713.721.713 1.883 0 2.6-.719.721-1.889.721-2.609 0-.719-.719-.719-1.879 0-2.598.182-.18.387-.316.605-.406V8.835c-.217-.091-.424-.222-.6-.401-.545-.545-.676-1.342-.396-2.009L7.636 3.7.45 10.881c-.6.605-.6 1.584 0 2.189l10.48 10.477c.604.604 1.582.604 2.186 0l10.43-10.43c.605-.603.605-1.582 0-2.187"/></svg> },
                        { name: "GitHub", logo: <svg className="w-6 h-6" viewBox="0 0 24 24" fill="#181717"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/></svg> },
                ...
                <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-xl hover:shadow-2xl transition-all duration-500">
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {[
                        { name: "Python", logo: <svg className="w-6 h-6" viewBox="0 0 24 24" fill="#3776ab"><path d="M14.25.18l.9.2.73.26.59.3.45.32.34.34.25.34.16.33.1.3.04.26.02.2-.01.13V8.5l-.05.63-.13.55-.21.46-.26.38-.3.31-.33.25-.35.19-.35.14-.33.1-.3.07-.26.04-.21.02H8.77l-.69.05-.59.14-.5.22-.41.27-.33.32-.27.35-.2.36-.15.37-.1.35-.07.32-.04.27-.02.21v3.06H3.17l-.21-.03-.28-.07-.32-.12-.35-.18-.36-.26-.36-.36-.35-.46-.32-.59-.28-.73-.21-.88-.14-1.05-.05-1.23.06-1.22.16-1.04.24-.87.32-.71.36-.57.4-.44.42-.33.42-.24.4-.16.36-.1.32-.05.24-.01h.16l.06.01h8.16v-.83H6.18l-.01-2.75-.02-.37.05-.34.11-.31.17-.28.25-.26.31-.23.38-.2.44-.18.51-.15.58-.12.64-.1.71-.06.77-.04.84-.02 1.27.05zm-6.3 1.98l-.23.33-.08.41.08.41.23.34.33.22.41.09.41-.09.33-.22.23-.34.08-.41-.08-.41-.23-.33-.33-.22-.41-.09-.41.09zm13.09 3.95l.28.06.32.12.35.18.36.27.36.35.35.47.32.59.28.73.21.88.14 1.04.05 1.23-.06 1.23-.16 1.04-.24.86-.32.71-.36.57-.4.45-.42.33-.42.24-.4.16-.36.09-.32.05-.24.02-.16-.01h-8.22v.82h5.84l.01 2.76.02.36-.05.34-.11.31-.17.29-.25.25-.31.24-.38.2-.44.17-.51.15-.58.13-.64.09-.71.07-.77.04-.84.01-1.27-.04-1.07-.14-.9-.2-.73-.25-.59-.3-.45-.33-.34-.34-.25-.34-.16-.33-.1-.3-.04-.25-.02-.2.01-.13v-5.34l.05-.64.13-.54.21-.46.26-.38.3-.32.33-.24.35-.2.35-.14.33-.1.3-.06.26-.04.21-.02.13-.01h5.84l.69-.05.59-.14.5-.21.41-.28.33-.32.27-.35.2-.36.15-.36.1-.35.07-.32.04-.28.02-.21V6.07h2.09l.14.01zm-6.47 14.25l-.23.33-.08.41.08.4.23.34.33.22.41.09.41-.09.33-.22.23-.34.08-.4-.08-.41-.23-.33-.33-.22-.41-.09-.41.09z"/></svg> },
                        { name: "Machine Learning", logo: <svg className="w-6 h-6" viewBox="0 0 24 24" fill="#FF6F00"><circle cx="5" cy="12" r="2" fill="#FF6F00"/><circle cx="12" cy="5" r="2" fill="#FF6F00"/><circle cx="12" cy="19" r="2" fill="#FF6F00"/><circle cx="19" cy="12" r="2" fill="#FF6F00"/><path d="M7 12h10M12 7v10" stroke="#FF6F00" strokeWidth="2"/></svg> },
                        { name: "Data Analysis", logo: <svg className="w-6 h-6" viewBox="0 0 24 24" fill="#4CAF50"><path d="M3 3v18h18v-2H5V3H3zm4 14h2v-6H7v6zm4 0h2V9h-2v8zm4 0h2v-4h-2v4z"/></svg> },
                        { name: "TensorFlow", logo: <svg className="w-6 h-6" viewBox="0 0 24 24" fill="#FF6F00"><path d="M1.292 5.856L11.54 0v24l-4.095-2.378V7.603l-6.168 3.564.015-5.31zm21.416 5.311l-6.168-3.564V7.603L10.375 4.7 21.708 11.168v-5.31z"/></svg> },
              ...
              <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-3xl p-12 text-center shadow-2xl">
                <div className="space-y-8">
                  <div className="space-y-4">
                    <h3 className="text-3xl font-bold text-white">Beyond Code</h3>
                    <p className="text-purple-100 text-lg max-w-2xl mx-auto">
                      When I'm not coding, you'll find me exploring creative outlets that fuel my passion for innovation.
                    </p>
                  </div>
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                    {[
                      ...
                      <div key={item.name} className="bg-white/20 backdrop-blur-sm rounded-xl p-4 text-center hover:bg-white/30 transition-all duration-300">
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-1">
                          <p className="text-gray-900 font-medium">shakyasyd@gmail.com</p>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-1">
                          <p className="text-gray-900 font-medium">siddhartha.shakya@deerwalk.edu.np</p>
                        </div>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-1">
                          <p className="text-gray-900 font-medium">Sanobharyang, Kathmandu</p>
