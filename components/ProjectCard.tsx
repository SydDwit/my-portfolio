    ...
    >
        ...
        <div className={`absolute bottom-4 left-4 right-4 transition-all duration-500 ${
          ...
          <div className="flex gap-3">
            ...
            {project.githubUrl && (
              ...
              >
                <svg className="w-4 h-4 transition-transform group-hover/btn:rotate-12" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="p-6">
          ...
          {(showAllTechs ? project.technologies : project.technologies.slice(0, 3)).map((tech, index) => (
            <span
              ...
              style={{
                ...
                animation: isHovered ? 'fadeInUp 0.5s ease-out forwards' : undefined
              }}
            >
              {tech}
            </span>
        ...
        <div className="mt-4 h-1 bg-secondary rounded-full overflow-hidden">
          <div className={`h-full bg-gradient-to-r from-primary to-primary/60 rounded-full transition-all duration-1000 ${
